...
import bisq.desktop.components.paymentmethods.data.NuBankData;
import bisq.desktop.util.Layout;
import bisq.desktop.util.validation.NuBankAccountEmailValidator;
import bisq.desktop.util.validation.NuBankAccountCpfValidator;
import bisq.desktop.util.validation.NuBankTransferValidator;
...
import bisq.core.payment.NuBankAccount;
...
public class NuBankTransferForm extends PaymentMethodForm
{
    private final NuBankAccount nuBankAccount;
    private InputTextField bankEmail,  InputTextField;
    private InputTextField bankCpf,  InputTextField;
/// stopped here
